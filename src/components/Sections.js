...
export function Team() {
  const coaches = [
    ...
    ['Mohammed Naeem', 'Co-founder & Head of S&C', 'Former professional Indian Hockey player. PG in Performance Science. 8+ years building athletes. Known for sustainable, elite transformations.'],
