...
function InlineForm() {
  const [fd, setFd] = useState({ name: '', phone: '', interest: 'Wrestling', notes: '' });
  ...
  const levels = [
    {
      ...
      items: [
        'Wrestling stance, level changes, motion — the foundation of every shot',
        'Hand fighting — collar ties, inside ties, wrist control, underhooks',
        'Fundamental takedowns — single leg (high-crotch, low-single), double leg',
        'Sprawl, whizzer, front headlock — stopping shots at the source',
        'Top and bottom positions — rides, breakdowns, stand-ups, switches',
        'Structured S&C built for wrestling — pulling strength, posterior chain, grip',
      ],
    },
    {
      ...
      items: [
        'Chain wrestling — linking attacks (shot to re-shot, single to double)',
        'Setups — arm drags, snap downs, ties to takedowns, level changes',
        'Mat wrestling — half nelson, cradles, tilts, granby rolls, escapes',
        'Duck-unders, high-crotch finishes, trip takedowns',
        'Live drilling with progressive resistance',
        'Wrestling-specific conditioning — match-pace rounds, scramble drills',
      ],
    },
    {
      label: 'For the Competitor',
      intro: 'You want to compete. We prepare you for the mat.',
      items: [
        'Freestyle vs Greco-Roman vs folkstyle — rules, scoring, and strategy',
        'Advanced attacks — ankle picks, fireman carry, throws, lateral drops',
        'Match strategy — riding time, positional dominance, par terre defense',
        'Full live wrestling with training partners matched to weight class',
        'Tournament preparation — state, national, university-level circuits',
        'Weight cutting done safely, match-day routines, recovery protocols',
      ],
    },
  ];
  return (
    ...
    <div style={{ minHeight: '100vh', background: T.cream }}>
      ...
      <div style={{ padding: '32px 16px 28px', maxWidth: 960, margin: '0 auto', opacity: v?1:0, transform: v?'translateY(0)':'translateY(20px)', transition: 'all 0.6s ease' }}>
        <div className="nc-landing-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 48, alignItems: 'start' }}>
          <div>
            <p style={{ fontFamily: T.fontBody, fontSize: 11, letterSpacing: 3, color: T.rust, textTransform: 'uppercase', fontWeight: 600, margin: '0 0 12px' }}>Wrestling classes in Bangalore</p>
            <h1 style={{ fontFamily: T.fontDisplay, fontSize: 'clamp(28px, 5vw, 42px)', fontWeight: 900, color: T.text, lineHeight: 1.1, textTransform: 'uppercase', letterSpacing: 1, margin: '0 0 20px' }}>The oldest art.<br/>Taught properly.</h1>
            <p style={{ fontFamily: T.fontBody, fontSize: 16, color: T.textLight, lineHeight: 1.7, margin: '0 0 32px', maxWidth: 480 }}>Wrestling is the foundation of combat sports. Learn from an NIS Patiala certified coach with a Master&#39;s in Sports Management and university-level coaching experience.</p>
            <div style={{ marginBottom: 36 }}>
              ...
              <h2 style={{ fontFamily: T.fontDisplay, fontSize: 24, fontWeight: 900, color: T.text, margin: '0 0 24px', textTransform: 'uppercase', letterSpacing: 0.5 }}>Wrestling at every level.</h2>
              {levels.map((lvl, i) => (
              ...
              <div style={{ marginTop: 24, padding: '18px 22px', background: 'rgba(227,199,104,0.12)', borderLeft: `3px solid ${T.gold}`, borderRadius: 4 }}>
                ...
                <p style={{ fontFamily: T.fontBody, fontSize: 13, color: T.textLight, lineHeight: 1.6, margin: 0 }}>Every wrestler here trains S&C. Non-negotiable at every level. Wrestling demands explosive strength and relentless endurance — we build the engine that powers shot after shot.</p>
              </div>
              <div style={{ marginTop: 16, padding: '18px 22px', background: T.warm, borderLeft: `3px solid ${T.rust}`, borderRadius: 4 }}>
                ...
                <p style={{ fontFamily: T.fontBody, fontSize: 13, color: T.textLight, lineHeight: 1.6, margin: 0 }}><strong style={{ color: T.text }}>Coach Venkatesh A</strong> — NIS Patiala certified Wrestling Coach, Master's in Sports Management, university-level coaching experience, certified wrestling official.</p>
              </div>
            </div>
            <div style={{ padding: '20px 24px', background: T.warm, borderRadius: 8, border: `1px solid ${T.border}` }}>
              ...
              <p style={{ fontFamily: T.fontSerif, fontSize: 15, color: T.text, lineHeight: 1.6, fontStyle: 'italic', margin: '0 0 10px' }}>10/10 facilities with amazing hands-on practice sessions for grappling and striking. Huge shoutout to Kantha sir, Venkatesh sir and Bhagyaraj sir for always helping me grow and learn.</p>
              <p style={{ fontFamily: T.fontBody, fontSize: 12, color: T.textMuted, fontWeight: 600, margin: '0 0 2px' }}>— Dhruv P</p>
          ...
          <div style={{ position: 'sticky', top: 24, opacity: v?1:0, transform: v?'translateY(0)':'translateY(20px)', transition: 'all 0.6s ease 0.3s' }}>
            <div style={{ background: '#fff', borderRadius: 12, padding: '32px 28px', border: `1px solid ${T.border}`, boxShadow: '0 4px 24px rgba(44,35,24,0.06)' }}>
              ...
              <p style={{ fontFamily: T.fontBody, fontSize: 13, color: T.textLight, margin: '0 0 24px' }}>We&apos;ll call to schedule your complimentary wrestling trial.</p>
              <InlineForm />
            </div>
