...
export default async function PublicFormPage({ params }) {
  ...
  if (tokenRow.usedAt) return <ErrorShell title="Already submitted">Thank you — your form was already received on {tokenRow.usedAt.toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}.</ErrorShell>;
  if (tokenRow.trial.healthDecl) return <ErrorShell title="Already submitted">Thank you — your form was already received.</ErrorShell>;
