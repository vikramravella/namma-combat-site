  ...
  const levels = [
    {
      ...
      intro: "You've never thrown a punch. That's where we start.",
      items: [
        'Orthodox and southpaw stance, high guard, pivot footwork',
        'The jab — range-finder, rhythm-breaker, highest-scoring punch in boxing',
        'Head movement first — slip, roll, pull, block, parry',
        'Mitts and focus pads to build clean mechanics before the bag',
        'Distance, timing, and the four ranges (out-fighting, mid-range, inside, clinch)',
        'Structured S&C for boxing-specific durability',
      ],
    },
    {
      label: 'For the Intermediate',
      intro: 'You know the punches. Now we build the boxer.',
      items: [
        'The full arsenal — jab, cross, hooks (lead + rear), uppercuts, overhands',
        'Setting the jab — jab-cross-hook, double jab, jab to the body',
        'Body work — hook to the liver, straight to the solar plexus, digging shots',
        'Counter-punching — catch-and-shoot, slip-and-rip, pull-counter',
        'Controlled sparring — situational rounds, timing, pressure',
        'Boxing-specific rounds — pad intensity matched to fight pace',
      ],
    },
    {
      label: 'For the Competitor',
      intro: 'You want to fight. We prepare you for the ring.',
      items: [
        'Ring generalship — cutting the ring, controlling the centre, angles',
        'Fight IQ — reading styles, baiting, feinting, changing levels',
        'Stance switching and southpaw problem-solving',
        'Full sparring with hard partners, rounds matched to fight length',
        'Camp structure — peak weeks, tapering, weight management, corner drills',
        'Amateur rules, scoring, and tactics for 3-round bouts',
      ],
    },
  ];
  return (
        ...
        <div className="nc-landing-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 48, alignItems: 'start' }}>
          <div>
            ...
            <div style={{ marginBottom: 36 }}>
              ...
              <h2 style={{ fontFamily: T.fontDisplay, fontSize: 24, fontWeight: 900, color: T.text, margin: '0 0 24px', textTransform: 'uppercase', letterSpacing: 0.5 }}>Boxing at every level.</h2>
              {levels.map((lvl, i) => (
              ...
              <div style={{ marginTop: 24, padding: '18px 22px', background: 'rgba(227,199,104,0.12)', borderLeft: `3px solid ${T.gold}`, borderRadius: 4 }}>
                ...
                <p style={{ fontFamily: T.fontBody, fontSize: 13, color: T.textLight, lineHeight: 1.6, margin: 0 }}>Every boxer here trains S&C. Non-negotiable at every level. Beginners build durability. Intermediates build power. Competitors build fight-ready conditioning. Boxing-specific — not generic lifting.</p>
              </div>
              <div style={{ marginTop: 16, padding: '18px 22px', background: T.warm, borderLeft: `3px solid ${T.rust}`, borderRadius: 4 }}>
                ...
                <p style={{ fontFamily: T.fontBody, fontSize: 13, color: T.textLight, lineHeight: 1.6, margin: 0 }}><strong style={{ color: T.text }}>Coach Bhagyarajan</strong> — NIS Patiala certified, multiple national Gold + Best Boxer awards, decades of ring experience distilled into every session.</p>
              </div>
            </div>
