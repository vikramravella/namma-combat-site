...
export default function CorporateLanding() {
  ...
  useEffect(() => { setV(true); }, []);
  const points = [
    ['Stress meets its match', "Nothing clears your head like hitting pads for an hour. Boxing, kickboxing, and S&C sessions that replace your cortisol with clarity."],
    ['Premium, not intimidating', "Clean stucco interiors, Yamaha audio, Technogym equipment, pristine hygiene. A corporate executive feels as comfortable here as a pro athlete."],
    ['Flexible scheduling', "Sessions from 6 AM to 9 PM, Monday to Saturday. Early morning boxing before work. Lunchtime S&C. Evening wind-down with Animal Flow."],
    ['Free postural assessment', "Desk posture is destroying your body. Our assessment identifies every imbalance from years of sitting — then we fix it systematically."],
    ['Structured beginner plan', "Never done combat sports? Perfect. 8 S&C classes + 4 combat sessions in your first 2 weeks. Zero ego, complete support."],
  ];
  return (
      ...
      <div style={{ padding: '48px 24px 40px', maxWidth: 960, margin: '0 auto', opacity: v?1:0, transform: v?'translateY(0)':'translateY(20px)', transition: 'all 0.6s ease' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 48, alignItems: 'start' }}>
          <div>
            ...
            <h1 style={{ fontFamily: T.fontDisplay, fontSize: 'clamp(28px, 5vw, 42px)', fontWeight: 900, color: T.text, lineHeight: 1.1, textTransform: 'uppercase', letterSpacing: 1, margin: '0 0 20px' }}>Not a gym.<br/>A reset button.</h1>
            ...
            <div style={{ padding: '20px 24px', background: T.warm, borderRadius: 8, border: `1px solid ${T.border}` }}>
              ...
              <p style={{ fontFamily: T.fontSerif, fontSize: 15, color: T.text, lineHeight: 1.6, fontStyle: 'italic', margin: '0 0 10px' }}>As a complete beginner, my experience has been absolutely amazing. The training is customized to suit each individual&apos;s strengths. The standards here have far exceeded my expectations.</p>
              <p style={{ fontFamily: T.fontBody, fontSize: 12, color: T.textMuted, fontWeight: 600, margin: '0 0 2px' }}>— Lochen Raj GM</p>
              <p style={{ fontFamily: T.fontBody, fontSize: 11, color: T.textMuted, margin: 0 }}>Beginner · 1 month training</p>
            </div>
          </div>
