    ...
    <div style={{ minHeight: '100vh', background: T.cream }}>
      ...
      <div style={{ padding: '48px 24px 64px', maxWidth: 760, margin: '0 auto', opacity: v?1:0, transform: v?'translateY(0)':'translateY(20px)', transition: 'all 0.6s ease' }}>
        ...
        <div className="policy-body">
          ...
          <p>Our website uses third-party services including Vercel (hosting), Supabase (database), Google Analytics, Google Fonts, WhatsApp, and others. When you interact with these services through our website, the respective provider&apos;s terms and privacy policies also apply. We are not responsible for the practices of third-party services.</p>
