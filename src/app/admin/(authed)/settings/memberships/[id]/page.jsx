    ...
    <>
      <div className="adm-page-header">
        <div>
          ...
          <p className="adm-page-subtitle">{usageCount} membership{usageCount === 1 ? '' : 's'} sold under this tier+cycle. Editing changes future sales only — historical memberships keep their original snapshot.</p>
        </div>
      </div>
