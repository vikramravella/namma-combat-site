...
function InlineForm() {
  const [fd, setFd] = useState({ name: '', phone: '', interest: 'Kickboxing', notes: '' });
  ...
  const levels = [
    {
      ...
      items: [
        'Orthodox and southpaw stance, Thai-style high guard, pivot footwork',
        'The teep (foot jab) — the most underrated strike in kickboxing',
        'Low kick, middle (round) kick, high kick — rotation from the hip, shin as the weapon',
        'Hands first — jab, cross, hook, uppercut with kickboxing-specific defense',
        'Check kicks and catch-and-counter defense against leg attacks',
        'Structured S&C for flexibility, shin conditioning, kick-specific power',
      ],
    },
    {
      ...
      items: [
        'Full kick arsenal — inside low, outside low, body kick, head kick, switch kick',
        'The clinch (plum) — knee strikes, sweeps, off-balancing, breaking posture',
        'Elbow work — horizontal, upward, spinning (Muay Thai range)',
        'Dutch-style combinations — hands to kicks and kicks to hands',
        'Counter-fighting — teep-to-counter, catch-kick-to-sweep',
        'Controlled sparring with kickboxing pace and tempo',
      ],
    },
    {
      ...
      items: [
        'Range management — long (kicks), mid (hands), short (clinch and knees)',
        'Fight IQ — reading stances, attacking the lead leg, setting up head kicks',
        'Advanced clinch work — dominant positions, knees to body and head',
        'Full sparring matched to fight rules (Muay Thai vs K-1 vs amateur)',
        'Camp structure — peak weeks, weight management, corner work',
        'Competition prep across formats — amateur, full rules, K-1 style',
      ],
    },
  ];
  return (
    ...
    <div style={{ minHeight: '100vh', background: T.cream }}>
      ...
      <div style={{ padding: '32px 16px 28px', maxWidth: 960, margin: '0 auto', opacity: v?1:0, transform: v?'translateY(0)':'translateY(20px)', transition: 'all 0.6s ease' }}>
        <div className="nc-landing-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 48, alignItems: 'start' }}>
          <div>
            <p style={{ fontFamily: T.fontBody, fontSize: 11, letterSpacing: 3, color: T.rust, textTransform: 'uppercase', fontWeight: 600, margin: '0 0 12px' }}>Kickboxing classes in Bangalore</p>
            <h1 style={{ fontFamily: T.fontDisplay, fontSize: 'clamp(28px, 5vw, 42px)', fontWeight: 900, color: T.text, lineHeight: 1.1, textTransform: 'uppercase', letterSpacing: 1, margin: '0 0 20px' }}>Kicks that mean<br/>something.</h1>
            <p style={{ fontFamily: T.fontBody, fontSize: 16, color: T.textLight, lineHeight: 1.7, margin: '0 0 32px', maxWidth: 480 }}>Not a cardio class with pads. Real kickboxing technique — strikes, kicks, knees, elbows, clinch work. Taught by experienced fighters who have trained at the highest level.</p>
            <div style={{ marginBottom: 36 }}>
              ...
              <h2 style={{ fontFamily: T.fontDisplay, fontSize: 24, fontWeight: 900, color: T.text, margin: '0 0 24px', textTransform: 'uppercase', letterSpacing: 0.5 }}>Kickboxing at every level.</h2>
              {levels.map((lvl, i) => (
              ...
              <div style={{ marginTop: 24, padding: '18px 22px', background: 'rgba(227,199,104,0.12)', borderLeft: `3px solid ${T.gold}`, borderRadius: 4 }}>
                ...
                <p style={{ fontFamily: T.fontBody, fontSize: 13, color: T.textLight, lineHeight: 1.6, margin: 0 }}>Every kickboxer here trains S&C. Non-negotiable at every level. Leg strength for kicks, core rotation for power, cardio built for rounds — kickboxing-specific conditioning, not generic lifting.</p>
              </div>
            ...
            <div style={{ padding: '20px 24px', background: T.warm, borderRadius: 8, border: `1px solid ${T.border}` }}>
              ...
              <p style={{ fontFamily: T.fontSerif, fontSize: 15, color: T.text, lineHeight: 1.6, fontStyle: 'italic', margin: '0 0 10px' }}>Authentic, high-energy, and grit-focused. Elite coaching providing world-class technical depth in MMA, boxing, wrestling, and Muay Thai. One of the best places to train in Bangalore.</p>
              <p style={{ fontFamily: T.fontBody, fontSize: 12, color: T.textMuted, fontWeight: 600, margin: '0 0 2px' }}>— Nitish R</p>
          ...
          <div style={{ position: 'sticky', top: 24, opacity: v?1:0, transform: v?'translateY(0)':'translateY(20px)', transition: 'all 0.6s ease 0.3s' }}>
            <div style={{ background: '#fff', borderRadius: 12, padding: '32px 28px', border: `1px solid ${T.border}`, boxShadow: '0 4px 24px rgba(44,35,24,0.06)' }}>
              ...
              <p style={{ fontFamily: T.fontBody, fontSize: 13, color: T.textLight, margin: '0 0 24px' }}>We&apos;ll call to schedule your complimentary kickboxing trial.</p>
              <InlineForm />
            </div>
